<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="yonet1-1.aspx.cs" Inherits="Proje.yonet112" %>
 ...
 <table style="padding:10%; margin-left:27%;" class="auto-style5" >
     <tr>
         ...
         <td class="auto-style1">
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <asp:TextBox ID="TextBox1" runat="server" ReadOnly="True" BackColor="#BFBFBF" BorderStyle="None" Enabled="False" Width="49px"></asp:TextBox>
         </td>
     </tr>
   <tr>
       <td></td><td class="auto-style6">
       <asp:Label ID="Label8" runat="server" Text="Performans 【﻿１．１．１】"></asp:Label>
       </td>
       <td class="auto-style4">&nbsp;&nbsp;
            <asp:Label ID="Label6" runat="server" Text="Performans 【﻿１．１．２】"></asp:Label>
       </td>
       <td class="auto-style1"><asp:Label ID="Label7" runat="server" Text="Performans 【﻿１．１．３】" Width="200px"></asp:Label></td>
   </tr>
     <br /><tr>
         <td>Hedef</td>
