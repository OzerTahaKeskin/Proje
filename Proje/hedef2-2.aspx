<%@ Page Title="" Language="C#" MasterPageFile="~/hedef1.Master" AutoEventWireup="true" CodeBehind="hedef2-2.aspx.cs" Inherits="Proje.hedef2_2" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" style="color:dodgerblue"; aria-current="page">Hedef 【﻿２．２】</li>
  </ol>
</nav>
     </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="card-body">
    <h5 class="card-title" style="color:orange;">Hedef 【﻿２．２】</h5>
    <hr />
    <p class="card-text">Belediyemizin dâhil olduğu hukuki süreçlerin etkin takibini yaparak iş ve işlemlerin yürürlükteki mevzuata uygunluğunu sağlamak</p>
   <hr />
      ...
      <hr />
        <ul>
       <li>Hukuki görüş taleplerinin süresinde karşılanmaması nedeniyle işlemin mevzuata uygun olmayan yönleriyle yürütülmesi ve oluşabilecek kamu zararı</li>
        <li>Davalardaki yasal sürelere uyulmaması nedeniyle kurumun karşılaşabileceği mali, hukuki ve cezai sorumluluklar</li>
      </ul>
      <hr />
     ...
     <p> Dönemsel yoğunluklar sebebiyle hukuki süreçlerin etkin izleme ve değerlendirmesinin yapılamaması</p>
      <hr />
      <h6 style="color:orange;">İhtiyaçlar</h6>
      <p>Hukuki süreçlerin etkin izleme ve değerlendirme sistemi ihtiyacı</p>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <a href="per2-2.aspx"><button type="button" class="btn btn-secondary" style="float:left; margin-left:20px; width:200px;">Faaliyet ve Projeler</button></a> 
    </div>
