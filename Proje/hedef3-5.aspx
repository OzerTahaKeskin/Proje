<%@ Page Title="" Language="C#" MasterPageFile="~/hedef1.Master" AutoEventWireup="true" CodeBehind="hedef3-5.aspx.cs" Inherits="Proje.hedef3_5" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" style="color:dodgerblue"; aria-current="page">Hedef 【﻿３．５】</li>
  </ol>
</nav>
     </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card" style="width: 100%; height:1070px;">
  <div class="card-body">
    <h5 class="card-title" style="color:orange;">Hedef 【﻿３．５】</h5>
    <hr />
    <p class="card-text">Ulusal, uluslararası kurum ve kuruluşlarla ilişkileri yürütmek, yeni iş birlikleri kurmak, ulusal ve uluslararası fon kaynaklarına projeler geliştirmek</p>
   <hr />
      ...
      <ul>
          <li>Sosyal Destek Hizmetler Müdürlüğü</li>
          <li>Kültür İşleri Müdürlüğü</li>
      </ul>
      <hr />
      <h6 style="color:orange;">Riskler</h6>
      <hr />
        <ul>
        <li>Ulusal ve uluslararası işbirliklerinin ve kurumsal ilişkilerin etkin yönetilememesi</li>
        <li>Fon sağlayıcı ulusal ve uluslararası kurumların projeleri onaylamaması</li>
        <li>İhtiyaçların bütçe olanaklarının aşması</li>
        <li>Proje eğitimlerine gereken ilginin gösterilmemesi</li>
      </ul> 
      <hr />
      ...
      <h6 style="color:orange;">Tespitler</h6>
       <ul>
         <li>Mali kaynakların sınırlılığı sebebiyle oluşturulan projeler büyük oranda hibe ve fon kaynaklarına yönelik olması</li>
         <li>Verilen eğitimlerin katılımcılara sağlayacağı katkı konusunda katılımcıların farkındalığının zayıf olması</li>
      </ul>
      <hr />
      <h6 style="color:orange;">İhtiyaçlar</h6>
       <ul>
          <li>Mali kaynakların artırılması</li>
          <li>Verilen eğitimlerle personelin projelendirmenin iş yönetim süreçlerine katkısı konusunda farkındalığının artırılması</li>
      </ul>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <a href="per3-5.aspx"><button type="button" class="btn btn-secondary" style="float:left; margin-left:20px; width:200px;">Faaliyet ve Projeler</button></a> 
    </div>
