<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="yonet1-4.aspx.cs" Inherits="Proje.yonet1_4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <table style="padding:10%; margin-left:27%;" class="auto-style5" >
   ...
   <tr>
       ...
       <asp:Label ID="Label8" runat="server" Text="Performans 【﻿１．４．１】"></asp:Label>
       </td>
       <td class="auto-style4">&nbsp;&nbsp;
            <asp:Label ID="Label6" runat="server" Text="Performans 【﻿１．４．２】"></asp:Label>
       </td>
       <td class="auto-style1"><asp:Label ID="Label7" runat="server" Text="Performans 【﻿１．４．３】" Width="200px"></asp:Label></td>
   </tr>
     <br /><tr>
         <td>Hedef</td>
