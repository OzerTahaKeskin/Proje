<%@ Page Title="" Language="C#" MasterPageFile="~/hedef1-1.Master" AutoEventWireup="true" CodeBehind="gos1-1-2.aspx.cs" Inherits="Proje.gos1_1_2" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" style="color:dodgerblue"; aria-current="page">Performans 【﻿１．１．２】</li>
  </ol>
</nav>
     </asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="card-body">
    <h5 class="card-title" style="color:orange;">Performans 【﻿１．１．２】</h5>
    <hr />
   ...
   <a href="gos1-1-1.aspx" style="text-decoration:none;"><li class="list-group-item">Düzenlenen etkinlik sayısı </li></a>
   <a><li class="list-group-item" style="background:#000; color:white;">Eğitim verilen personel sayısı</li></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <a href="per1-1.aspx"><button type="button" class="btn btn-secondary" style="float:left; margin-left:20px; width:200px;">Faaliyet ve Projeler</button></a> 
     ...
     <table style="border:solid 1px black; width:90%; height:400px;">
        <tr>
            <td>
