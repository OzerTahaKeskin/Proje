<%@ Page Title="" Language="C#" MasterPageFile="~/hedef1-1.Master" AutoEventWireup="true" CodeBehind="gos1-1-3.aspx.cs" Inherits="Proje.gos1_1_3" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" style="color:dodgerblue"; aria-current="page">Performans 【﻿１．１．３】</li>
  </ol>
</nav>
     </asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="card-body">
    <h5 class="card-title" style="color:orange;">Performans 【﻿１．１．３】</h5>
    <hr />
  ...
  <a><li class="list-group-item" style=" background:aqua;">İstihdam edilen stajyer öğrenci sayısı</li></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <a href="per1-1.aspx"><button type="button" class="btn btn-secondary" style="float:left; margin-left:20px; width:200px;">Faaliyet ve Projeler</button></a> 
     ...
     <table style="border:solid 1px aqua; width:90%; height:400px;">
        <tr>
            <td>
