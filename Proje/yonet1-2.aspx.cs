...
namespace Proje
{
    public partial class yonet111 : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from hedef12", baglantiaraci);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            up.CommandText = "update hedef12 set yil=@yil,performans121=@performans121,hedef121=@hedef121,performans122=@performans122,hedef122=@hedef122,performans123=@performans123,hedef123=@hedef123 where id=@id";
            up.Parameters.AddWithValue("@yil", TextBox1.Text);
            up.Parameters.AddWithValue("@hedef121", TextBox2.Text);
            up.Parameters.AddWithValue("@performans121", TextBox3.Text);
            up.Parameters.AddWithValue("@hedef122", TextBox4.Text);
            up.Parameters.AddWithValue("@performans122", TextBox5.Text);
            up.Parameters.AddWithValue("@hedef123", TextBox6.Text);
            up.Parameters.AddWithValue("@performans123", TextBox7.Text);
