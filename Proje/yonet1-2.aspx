<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="yonet1-2.aspx.cs" Inherits="Proje.yonet111" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <table style="padding:10%; margin-left:27%;" class="auto-style5" >
   ...
   <tr>
       ...
       <asp:Label ID="Label8" runat="server" Text="Performans 【﻿１．２．１】"></asp:Label>
       </td>
       <td class="auto-style4">&nbsp;&nbsp;
            <asp:Label ID="Label6" runat="server" Text="Performans 【﻿１．２．２】"></asp:Label>
       </td>
       <td class="auto-style1"><asp:Label ID="Label7" runat="server" Text="Performans 【﻿１．２．３】" Width="200px"></asp:Label></td>
   </tr>
     <br /><tr>
         <td>Hedef</td>
         ...
         <td class="auto-style4">&nbsp;&nbsp;
             <asp:TextBox ID="TextBox4" runat="server" OnTextChanged="TextBox4_TextChanged" CssClass="auto-style2"></asp:TextBox>
         </td>
         <td class="auto-style1">
